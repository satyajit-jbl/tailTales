    ...
    return (
        ...
        <div className="text-center my-8 ">
            <div className="flex justify-center items-center space-x-2 ">
                ...
                {/* Heading */}
                <h2 className="text-3xl font-bold text-gray-800 mt-4 mb-2 dark:bg-gray-800 dark:text-white">
                    {heading}
                </h2>
            ...
            {/* Subheading */}
            <p className="text-gray-600 text-lg dark:bg-gray-800 dark:text-white">
                {subHeading}
            </p>
        </div>
